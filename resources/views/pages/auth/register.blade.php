...
@section('page_content')
    ...
    <div class="absolute inset-0 top-28 flex flex-col items-center justify-center">
        <img src="img/logo/logo_transparent.png" class="brightness-0 invert-[1] lg:hidden">
        <div
            ...
            <h1 class="text-center text-orange-700 text-3xl font-[Poppins] font-bold">Register</h1>
            <form method="POST" action="{{ route('auth.register') }}">
                @csrf
                <label class="text-orange-800 font-[Poppins]">Email</label><br>
                <input type="text" name="email" class="border border-orange-700 rounded-2xl w-full py-1 px-3"
                    placeholder="Your Email Here"><br>
                <label class="text-orange-800 font-[Poppins]">Username</label><br>
                <input type="text" name="name" class="border border-orange-700 rounded-2xl w-full py-1 px-3"
                    placeholder="Your Username Here">
                <label class="text-orange-800 font-[Poppins]">Password</label><br>
                <input type="password" name="password" class="border border-orange-700 rounded-2xl w-full py-1 px-3"
                    placeholder="Min. 8 Characters">
                <label class="text-orange-800 font-[Poppins]">Confirm Password</label><br>
                <input type="password" name="password_confirmation"
                    class="border border-orange-700 rounded-2xl w-full py-1 px-3" placeholder="Re-type your password">

                <input type="submit"
                    class="bg-orange-700 text-white font-[Poppins] font-semibold text-center w-full mt-5 rounded-full py-2"
                    value="Register">
